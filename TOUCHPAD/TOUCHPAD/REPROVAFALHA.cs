    ...
    public partial class REPROVAFALHA : MaterialSkin.Controls.MaterialForm
    {
        ...
        public void CriarLogFalha()
        {
            try
            {
                ...
                //Criar log de voz
                System.IO.StreamWriter sw2 = new StreamWriter(@"C:\TESTES_AVELL_VIRTUO\logs_touch\Falha" + dataHoraMinuto + ".log");
        ...
        public void CriarLog_MySQLFalha()
        {
            ...
            foreach (ManagementObject obj in collection)
            {
                ...
                string Furmark = "C:\\TESTES_AVELL_VIRTUO\\MySqlData\\" + NomeArquivo + "\\Touchpad_FALHA.txt";
            ...
            try
            {
                ...
                foreach (ManagementObject getserial in MOS1.Get())
                {
                    ...
                    String InfoTouchpad = "Touchpad Falha: " + dataHoraMinuto;
