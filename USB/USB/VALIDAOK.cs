...
namespace USB
{
    public partial class VALIDAOK : MaterialSkin.Controls.MaterialForm
    {
        ...
        public void Interacao()
        {
            ...
            wplayer.URL = @"C:\TESTES_AVELL_VIRTUO\audiofilesAlertas\USBOk.mp3";
        ...
        public void CriarLogOK_MySQL()
        {
            try
            {
                ...
                const string Usb = @"C:\TESTES_AVELL_VIRTUO\MySqlData\Usb.txt";
        ...
        public void GerarLogIndividual()
        {
            try
            {
                ...
                var dataHoraMinutoOK = DateTime.Now.ToString("dd-MM-yyyy-HH:mm:s:s");
                const string Drivers = @"C:\TESTES_AVELL_VIRTUO\logs_usb\Usb.log";
        ...
        public void CriarLog_MySQLOK()
        {
            ...
            foreach (ManagementObject obj in collection)
            {
                ...
                //Gera Log de OK para o MySql
                var dataHoraMinutoOK = DateTime.Now.ToString("dd-MM-yyyy-HH:mm:s:s");
                string Furmark = "C:\\TESTES_AVELL_VIRTUO\\MySqlData\\" + NomeArquivo + "\\USB_OK.txt";
