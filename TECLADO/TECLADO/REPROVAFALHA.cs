...
namespace TECLADO
{
    public partial class REPROVAFALHA : MaterialSkin.Controls.MaterialForm
    {
        ...
        public void Interacao()
        {
            ...
            wplayer.URL = @"C:\TESTES_AVELL_VIRTUO\audiofilesAlertas\TecladoFalha.mp3";
        ...
        public void CriarLogFalha()
        {
            try
            {
                ...
                //Criar log de voz
                System.IO.StreamWriter sw2 = new StreamWriter(@"C:\TESTES_AVELL_VIRTUO\logs_teclado\Falha" + dataHoraMinuto + ".log");
        ...
        public void CriarLog_MySQLFalha()
        {
            ...
            foreach (ManagementObject obj in collection)
            {
                ...
                string Furmark = "C:\\TESTES_AVELL_VIRTUO\\MySqlData\\" + NomeArquivo + "\\Furmark_FALHA.txt";
